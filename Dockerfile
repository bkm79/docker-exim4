...
RUN apt install -y libcurl uuid-dev libgcrypt-dev libestr-dev flex dh-autoreconf bison python-docutils libxml2-dev wget perl subversion libmysql++-dev re2c && \
